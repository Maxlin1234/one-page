export default function correctStylesheetsOrder({ preview, lightMode, showcases }) {
  ...
  if (lightMode && !preview) {
    ...
    if (showcases) {
      let pluginsStylesheets = document.querySelector(`link[href="/dark/assets/css/plugins.css"]`);
      if (pluginsStylesheets) pluginsStylesheets.remove();
      let globalStylesheets = document.querySelector(`link[href="/dark/assets/css/style.css"]`);
