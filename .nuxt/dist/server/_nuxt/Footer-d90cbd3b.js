...
import { mergeProps, withCtx, createTextVNode, useSSRContext, onUnmounted, unref } from "vue";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "parallax-show" }, _attrs))}><div class="bg-img inner parallaxie valign" data-background="/dark/assets/imgs/works/full/1.jpg" data-overlay-dark="3"><div class="container"><div class="row justify-content-center"><div class="col-lg-10"><div class="caption text-center"><h6 class="sub-title mb-30" data-swiper-parallax="-1000">© 2023 Branding</h6><h1>`);
      ...
      _push(`</h1></div></div></div></div></div><div class="bg-img inner parallaxie valign" data-background="/dark/assets/imgs/works/full/2.jpg" data-overlay-dark="3"><div class="container"><div class="row justify-content-center"><div class="col-lg-10"><div class="caption text-center"><h6 class="sub-title mb-30" data-swiper-parallax="-1000">© 2023 Branding</h6><h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/project-details1" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</h1></div></div></div></div></div><div class="bg-img inner parallaxie valign" data-background="/dark/assets/imgs/works/full/3.jpg" data-overlay-dark="3"><div class="container"><div class="row justify-content-center"><div class="col-lg-10"><div class="caption text-center"><h6 class="sub-title mb-30" data-swiper-parallax="-1000">© 2023 Branding</h6><h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/project-details1" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`</h1></div></div></div></div></div><div class="bg-img inner parallaxie valign" data-background="/dark/assets/imgs/works/full/4.jpg" data-overlay-dark="3"><div class="container"><div class="row justify-content-center"><div class="col-lg-10"><div class="caption text-center"><h6 class="sub-title mb-30" data-swiper-parallax="-1000">© 2023 Branding</h6><h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/project-details1" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=Footer-d90cbd3b.js.map
