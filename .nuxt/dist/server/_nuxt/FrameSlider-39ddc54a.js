...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data), (item, index) => {
        _push(`<div class="${ssrRenderClass(`slide ${index === 0 ? "slide--current" : ""}`)}"><h1 class="slide__title text-center"><span class="sub-title mb-15">© ${ssrInterpolate(item.year)} ${ssrInterpolate(item.type)}</span> <br><span>`);
...
//# sourceMappingURL=FrameSlider-39ddc54a.js.map
