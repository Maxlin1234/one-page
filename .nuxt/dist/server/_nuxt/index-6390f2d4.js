...
import { onUnmounted, mergeProps, withCtx, createTextVNode, createVNode, unref, useSSRContext, toDisplayString, openBlock, createBlock, createCommentVNode } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
import { _ as _imports_0$2 } from "./logo-light-8117e658.js";
import { d as data$2 } from "./app-data-475c97b4.js";
import { _ as _export_sfc, u as useHead } from "../server.mjs";
import { _ as __nuxt_component_0$2 } from "./client-only-29ef7f45.js";
import "swiper";
import { _ as _imports_0$3 } from "./circle-star-379b5691.js";
import "vue-router";
...
const _imports_0$1 = "" + __publicAssetsURL("landing-preview/img/star.svg");
const _sfc_main$7 = {};
...
const _imports_0 = "" + __publicAssetsURL("landing-preview/img/demos/more.jpg");
const data$1 = [
  {
    id: 0,
    link: "/dark/home-main",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(_attrs)}><div class="sub-footer pt-40 pb-40 ontop sub-bg"><div class="container"><div class="row"><div class="col-lg-4"><div class="logo"><a href="#0"><img${ssrRenderAttr("src", _imports_0$2)} alt=""></a></div></div><div class="col-lg-8"><div class="copyright d-flex"><div class="ml-auto"><p class="fz-13">© 2023 Geekfolio is Proudly Powered by <span class="underline"><a${ssrRenderAttr("href", unref(data$2).author_link)} target="_blank">${ssrInterpolate(unref(data$2).author)}</a></span></p></div></div></div></div></div></div></footer>`);
    };
  }
};
...
//# sourceMappingURL=index-6390f2d4.js.map
