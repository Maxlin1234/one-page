...
import { ssrRenderComponent, ssrRenderSlot } from 'file:///Users/linhankuan/Main_Files%E6%8B%B7%E8%B2%9D/geekfolio_nuxtjs/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    useHead({
      link: [
        ...
        { rel: "stylesheet", href: "/dark/showcase/assets/css/showcases.css" }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/showcases.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=showcases-6d892797.mjs.map
