...
import { useSSRContext, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString } from 'file:///Users/linhankuan/Main_Files%E6%8B%B7%E8%B2%9D/geekfolio_nuxtjs/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderComponent } from 'file:///Users/linhankuan/Main_Files%E6%8B%B7%E8%B2%9D/geekfolio_nuxtjs/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio section-padding pb-40" }, _attrs))}><div class="container-xxl"><div class="row"><div class="filtering col-12 mb-80 text-center"><div class="filter"><span class="text">Filter :</span><!--[-->`);
      ...
      _push(`<!--]--></div></div></div><div class="gallery"><div class="row grid md-marg"><!--[-->`);
      ssrRenderList(unref(data).gallery, (item) => {
        _push(`<div class="${ssrRenderClass(`col-lg-4 col-md-6 items ${item.filter} info-overlay mb-50`)}"><div class="item-img o-hidden">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Portfolio/ClassicGrid/3Col.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_2 = _sfc_main;

export { __nuxt_component_2 as _ };
//# sourceMappingURL=3Col-47da5553.mjs.map
