...
import { useSSRContext, mergeProps, unref, withCtx, createTextVNode } from 'file:///Users/linhankuan/Main_Files%E6%8B%B7%E8%B2%9D/geekfolio_nuxtjs/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrRenderComponent, ssrInterpolate } from 'file:///Users/linhankuan/Main_Files%E6%8B%B7%E8%B2%9D/geekfolio_nuxtjs/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data), (item) => {
        ...
        if (item.style.innerCol) {
          ...
          _push(`</h6><p>${ssrInterpolate(item.type)}</p></div><div class="ml-auto"><p class="fz-14">\xA9 ${ssrInterpolate(item.year)}</p></div></div></div></div>`);
        } else {
          ...
          _push(`</h6><p>${ssrInterpolate(item.type)}</p></div><div class="ml-auto"><p class="fz-14">\xA9 ${ssrInterpolate(item.year)}</p></div></div><!--]-->`);
        }
        _push(`</div></div>`);
      });
...
//# sourceMappingURL=ModernGrid-7d392d01.mjs.map
