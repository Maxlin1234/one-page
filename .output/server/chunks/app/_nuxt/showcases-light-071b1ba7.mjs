  ...
  setup(__props) {
    useHead({
      link: [
        ...
        { rel: "stylesheet", href: "/light/assets/css/base.css" },
        { rel: "stylesheet", href: "/light/showcase/assets/css/showcases.css" }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/showcases-light.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=showcases-light-071b1ba7.mjs.map
