...
import { _ as __nuxt_component_2 } from './CircleSlider-53d3339d.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main>`);
      _push(ssrRenderComponent(_component_ShowcasesCircleSlider, null, null, _parent));
      _push(`</main></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/showcase-circle-slider/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-89b030d8.mjs.map
