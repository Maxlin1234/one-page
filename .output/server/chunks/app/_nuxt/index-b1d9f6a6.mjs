...
import { _ as __nuxt_component_1 } from './Product-13fc4bf4.mjs';
import { _ as __nuxt_component_2 } from './Footer-d5f7be9e.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dark/shop-product/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-b1d9f6a6.mjs.map
