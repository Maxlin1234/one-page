...
import { _ as __nuxt_component_2 } from './ModernGrid-7d392d01.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      titleTemplate: `%s - Portfolio Modern`,
      bodyAttrs: {
        class: "main-bg"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PortfolioModernGrid = __nuxt_component_2;
      ...
      _push(ssrRenderComponent(_component_PortfolioModernGrid, null, null, _parent));
      _push(`</main>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/light/portfolio-modern/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-1159285b.mjs.map
