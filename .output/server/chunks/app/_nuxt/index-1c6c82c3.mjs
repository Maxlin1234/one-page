...
import { _ as __nuxt_component_2 } from './2Col-6bb9c573.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      titleTemplate: `%s - Portfolio Masonry 2 Col`,
      bodyAttrs: {
        class: "main-bg"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PortfolioMasonry2Col = __nuxt_component_2;
      ...
      _push(ssrRenderComponent(_component_PortfolioMasonry2Col, null, null, _parent));
      _push(`</main>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/light/portfolio-masonry-2/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-1c6c82c3.mjs.map
