...
import { _ as __nuxt_component_2 } from './3Col-fee7d89c.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    useHead({
      titleTemplate: `%s - Portfolio Masonry 3 Col`,
      bodyAttrs: {
        class: "main-bg"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_PortfolioMasonry3Col = __nuxt_component_2;
      ...
      _push(ssrRenderComponent(_component_PortfolioMasonry3Col, null, null, _parent));
      _push(`</main>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/light/portfolio-masonry-3/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-50397769.mjs.map
