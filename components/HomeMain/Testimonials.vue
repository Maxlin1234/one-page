<template>
  <section :class="`testim-crv2 section-padding sub-bg ${lightMode ? 'light' : ''}`">
    <div class="container">
      <div class="row">
        <div class="col-12">
        ...
        <div class="col-lg-7 wow fadeInUp" data-wow-delay=".4s">
          <div class="testim-swiper">
            <ClientOnly>
              <Swiper v-bind="swiperOptions" id="content-carousel-container-unq-testim" class="swiper-container">
                <SwiperSlide>
                  <div class="item">
                    <div class="cont mb-40">
                      ...
                      <h5 class="fw-400">I have been hiring people in this space for a number of years and I have never
                        seen this level of professionalism. It really feels like you are working with a team that can get
                        the job done.</h5>
                    </div>
                    <div class="d-flex align-items-center">
                      <div>
                        <div class="img circle-60">
                          <img :src="`/${lightMode ? 'light' : 'dark'}/assets/imgs/testim/1.jpg`" alt=""
                            class="circle-img" />
                        </div>
                      </div>
                      <div class="ml-30">
                ...
                <SwiperSlide>
                  <div class="item">
                    ...
                    <div class="d-flex align-items-center">
                      <div>
                        <div class="img circle-60">
                          <img :src="`/${lightMode ? 'light' : 'dark'}/assets/imgs/testim/2.jpg`" alt=""
                            class="circle-img" />
                        </div>
                      </div>
                      <div class="ml-30">
