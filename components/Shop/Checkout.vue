<template>
  <section :class="`shop-checkout ${lightMode ? 'light' : ''} section-padding`">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
            ...
            <div>
              ...
              <div class="text mt-40">
                <p>Your personal data will be used to process your order, support your experience throughout this website,
                  and for other purposes described in our <a href="#0">privacy policy</a>.</p>
              </div>
              <div class="mt-30">
                <button type="submit" class="main-colorbg4 butn butn-md butn-bg text-dark">
