<template>
  <section class="portfolio clasic section-padding" data-scroll-index="3">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-center">
            <div class="full-width d-flex justify-content-end justify-end">
              <div class="vew-all">
                <NuxtLink to="/dark/portfolio-classic-grid">View All Works
                  <span>
      ...
      <div class="row">
        <div :class="`col-lg-${index > 1 ? '4' : '6'}`" v-for="(item, index) in 
              data" :key="item.id">
          <div class="item mt-30">
            <div class="img">
              <img :src="item.image" alt="" class="radius-10" />
              <NuxtLink to="/dark/project-details1" class="tag">
