            ...
            <div class="circle-button">
              <div class="rotate-circle fz-16 ls1 text-u">
                <svg class="textcircle" viewBox="0 0 500 500">
                  ...
                  <text>
                    <textPath xlink:href="#textcircle" textLength="900"> Creative Branding Agency - Creative Branding
                      Agency - </textPath>
                  </text>
                </svg>
              </div>
        ...
        <div class="col-lg-7 valign">
          <div class="cont sec-lg-head">
            ...
            <h2 class="d-slideup wow">
              <span class="sideup-text"><span class="up-text">We’re sharp brands creators</span></span>
              <span class="sideup-text"><span class="up-text">open for any new collabs</span></span>
            </h2>
            <div class="row">
              <div class="col-lg-12">
                <div class="text mt-20">
                  <p>Grow brands through bold and strategic creative, focused on searching new ways to showcase user
                    content on digital support and envisioning the future arts.</p>
                </div>
                <div class="underline">
                  <NuxtLink to="/dark/page-about" class="mt-30 ls1 sub-title">Read More <i class="ml-5">
