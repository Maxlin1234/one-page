<template>
  <header class="header-creative">
      ...
      <div class="row justify-content-center full-height">
        <div class="col-lg-3 d-flex align-items-end">
          <div class="img md-hide">
            ...
            <img src="/dark/assets/imgs/header/c1.jpg" alt="" data-speed="0.01" class="parallax" />
          </div>
        </div>
          ...
          <div class="caption text-center full-width md-mb50">
            <div class="mb-30">
              <svg class="svg-animation star" width="100" height="100" viewBox="0 0 100 100" fill="none"
                ...
                <line y1="50" x2="100" y2="50" vectorEffect="non-scaling-stroke" stroke="currentColor"
            ...
            <h4 class="fw-300 mb-15">Digital agency studio</h4>
            <h1 class="fw-600 d-rotate wow">
              <span class="rotate-text">a creative digital</span>
              <span class="rotate-text">design studio</span>
            </h1>
          </div>
        </div>
        <div class="col-lg-3">
              ...
              <div class="circle-button hover-anim">
                <div class="rotate-circle fz-30 text-u">
                  <svg class="textcircle" viewBox="0 0 500 500">
                    ...
                    <text>
                      <textPath xlink:href="#textcircle1" textLength="900">Creative - Agency - Winner -</textPath>
                    </text>
                  </svg>
                </div>
    ...
    <div class="bg-pattern bg-img" :data-background="`/${lightMode ? 'light' : 'dark'}/assets/imgs/patterns/graph.png`">
    </div>
  </header>
</template>
