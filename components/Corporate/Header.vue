<template>
  <header class="slider slider-prlx o-hidden">
    ...
    <ClientOnly>
      <Swiper class="parallax-slider" v-bind="swiperOptions">
        <SwiperSlide v-for="item in  data " :key="item.id">
          <div class="bg-img valign" :data-background="item.background" data-overlay-dark="7">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-lg-10">
                  <div class="caption text-center">
                    ...
                    <h1 class="fz-60">{{ item.text }}</h1>
                    <NuxtLink :to="item.button.link" class="butn butn-md butn-bg main-colorbg3 text-dark mt-30">
                      {{ item.button.text }}
