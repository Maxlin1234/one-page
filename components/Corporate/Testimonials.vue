<template>
  <section :class="`testim-crv2 sub-bg position-re ${lightMode ? 'light' : ''}`">
    <div class="container section-padding position-re">
      <div class="row">
        <div class="col-lg-6 offset-lg-6">
          <div class="testim-swiper mt-80">
            <ClientOnly>
              <Swiper v-bind="swiperOptions" id="content-carousel-container-unq-testim">
                <SwiperSlide>
                  <div class="item">
                    <div class="cont mb-30">
                      <div class="rate-stars mb-20 fz-14">
                        <span class="rate main-color3">
                      ...
                      <h5 class="fw-400">
                        ...
                        professionalism. It really feels like you are working with a team that can get the job done.
                      </h5>
                    </div>
                    ...
                    <div class="d-flex align-items-center">
                      <div>
                        <div class="img circle-60">
                          <img :src="`${lightMode ? '/light' : '/dark'}/assets/imgs/testim/4.jpg`" alt=""
                            class="circle-img" />
                        </div>
                      </div>
                      <div class="ml-30">
      ...
      <div class="half-img-left bg-img ontop md-hide" data-background="/dark/assets/imgs/testim/01.png"></div>
    </div>
    <div class="bg-pattern bg-repeat bg-img opacity-1" data-background="/dark/assets/imgs/patterns/dots.png"></div>
  </section>
</template>
