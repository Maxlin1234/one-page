  ...
  <section class="team section-padding">
    <div class="container">
      <div class="sec-head mb-80">
        <div class="row">
          <div class="col-lg-8">
            <h6 class="sub-title opacity-8 wow fadeInUp">The Avengers</h6>
      ...
      <div class="row md-marg">
        <div class="col-lg-3 col-md-6" v-for="member in data" :key="member.id">
          <div class="item mb-50">
            <div class="img">
              <img :src="member.picture" alt="" />
            </div>
            <div class="info mt-20">
              <span class="fz-12 opacity-8">{{ member.position }}</span>
              <h6 class="fz-18">{{ member.name }}</h6>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="item-join valign">
            <div class="full-width">
              <h6 class="text-u ls2">Become <br /> A Member</h6>
              <NuxtLink to="/dark/page-team" class="arrow mt-30">
                <span class="circle">
                ...
                <span class="fz-12 text-u ml-10">Join Us</span>
              </NuxtLink>
            </div>
          </div>
        </div>
