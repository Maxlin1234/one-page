  ...
  <section class="services section-padding pb-0 block-pattern">
    <div class="container">
      <div class="sec-head mb-80">
        <div class="row">
          <div class="col-lg-5">
            <h6 class="sub-title opacity-8 wow fadeInUp">Main directions</h6>
          ...
          <div class="col-lg-4 d-flex align-items-center">
            <div class="text d-rotate wow md-mb30">
              <p class="rotate-text">Finding the best marketing solution for your business. Driven by data based on human
                behavior.</p>
            </div>
          </div>
    ...
    <div class="container-fluid rest">
      <div class="serv-items-crev">
        <div class="serv-swiper">
          <ClientOnly>
            <Swiper v-bind="swiperOptions" id="content-carousel-container-unq-serv">
              <SwiperSlide v-for="(item, index) in data" :key="item.id" class="wow fadeIn"
                :data-wow-delay="`${(data.length - index + 1) * 0.2}s`">
                <div class="item">
                  <div class="icon-img-60 mb-40">
                    <img :src="`${lightMode ? '/light/' : '/dark/'}${item.image}`" alt="" />
                  </div>
                  <h6 class="mb-15">{{ item.title }}</h6>
                  <p>{{ item.text }}</p>
                  <NuxtLink to="/dark/page-services" class="arrow mt-40">
                    <span class="circle">
                    ...
                    <span class="fz-12 text-u ml-10">Read More</span>
                  </NuxtLink>
                </div>
              </SwiperSlide>
            </Swiper>
