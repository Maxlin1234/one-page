      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="caption">
            ...
            <h1 class="fz-80">Talented team.</h1>
          </div>
          <div class="row">
            <div class="col-lg-9 offset-lg-1">
              <div class="text mt-30">
                <p>We’re a diverse team that works as fancies attention to details, enjoys beers on Friday nights and
                  aspires to design the dent in the universe.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-3 valign justify-end">
              ...
              <div class="circle-button">
                <div class="rotate-circle fz-30 text-u">
                  <svg class="textcircle" viewBox="0 0 500 500">
                    ...
                    <text>
                      <textPath xlink:href="#textcircle" textLength="900">Join Our Team - Join Our Team -</textPath>
                    </text>
                  </svg>
                </div>
                <div class="arrow">
