<template>
  <header class="page-header blog-header section-padding pb-0">
                ...
                <div class="author-info">
                  <div class="d-flex align-items-center">
                    <a href="#0" class="circle-60">
                      <img src="/dark/assets/imgs/blog/author1.jpg" alt="" class="circle-img" />
                    </a>
                    <a href="#0" class="ml-20">
                      <span class="opacity-7">Author</span>
                      <h6 class="fz-16">ThemesCamp</h6>
                    </a>
                  </div>
                </div>
    ...
    <div class="background bg-img parallaxie mt-80" data-background="/dark/assets/imgs/blog/b2.jpg"></div>
  </header>
</template>
