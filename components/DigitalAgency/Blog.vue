<template>
  <section class="blog-list-half section-padding">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-center">
            <div class="full-width d-flex justify-content-end justify-end">
              <div class="vew-all">
                <NuxtLink to="/dark/blog-list">View All Our News
                  <span>
      ...
      <div class="row">
        <div class="col-lg-6" v-for="item in data" :key="item.id">
          <div class="item md-mb50">
            <div class="row">
              <div class="col-lg-6 col-md-5 img">
              ...
              <div class="col-lg-6 col-md-7 sub-bg cont valign">
                <div class="full-width">
                  ...
                  <div class="tags mt-15">
                    <NuxtLink to="/dark/blog-list" class="me-1" v-for="(tag, i) in item.tags" :key="tag">{{ tag }}
                    </NuxtLink>
                  </div>
                </div>
              </div>
