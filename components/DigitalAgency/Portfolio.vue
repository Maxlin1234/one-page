      ...
      <div class="row">
        <div class="col-12">
          <div class="work-crus work-crus3 out">
            <ClientOnly>
              <Swiper id="content-carousel-container-unq-w" class="swiper-container" v-bind="swiperOptions">
                <SwiperSlide v-for="item in data" :key="item.id">
                  <div class="item">
                    <div class="img">
                      <img :src="`/dark/${item.image}`" alt="" />
                      <div class="cont">
                        <span class="mb-5">{{ item.type }}</span>
                        <h6 class="fz-18">{{ item.title }}</h6>
                      </div>
                      <NuxtLink to="/dark/project-details2" class="plink"></NuxtLink>
                    </div>
                  </div>
                </SwiperSlide>
              </Swiper>
...
//= Data
import data from '@/data/DigitalAgency/portfolio.json';
