        ...
        <div class="col-lg-3 offset-lg-1">
          <div class="colum md-mb50">
            ...
            <div class="text">
              ...
              <h5>
                <a href="#" class="main-color2">+1 840 841 25 69</a>
              </h5>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="copyright d-flex">
              <div class="ml-auto">
                <p class="fz-13">
                  © 2023 Geekfolio is Proudly Powered by <span class="underline"> <a :href="data.author_link"
                      target="_blank">{{ data.author }}</a></span>
                </p>
              </div>
            </div>
          </div>
